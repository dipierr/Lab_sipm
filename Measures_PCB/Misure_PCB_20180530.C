 ...
 *
 *  VALUES V_out 25 - 35 taken by Misure_PCB_20180511.C
 *
\******************************************************************************/

#define n 7

void Misure_PCB_20180530(){
    // TRIMMER
    double DAC[] =                {0.954,   1.049,    1.145,    1.240,    1.336 ,   1.432,   1.489};
    double errDAC[] =             {0.001,   0.001,    0.001,    0.001,    0.001 ,   0.001,   0.001};

    // LOAD: 39 kOhm
    double V_out_MAXi[] =         {25.00,   27.49,    30.00,    32.49,    34.99 ,   37.49,   39.00};
    double errV_out_MAXi[] =      {0.01,    0.01,     0.01,     0.01,     0.01  ,   0.01,    0.01};
    double V_vmon_MAXi[] =        {-0.917,  -1.008,   -1.100,   -1.191,   -1.283,   -1.374,  -1.429};
    double errV_vmon_MAXi[] =     {0.001,   0.001,    0.001,    0.001,    0.001 ,   0.001,   0.001};
    double V_imon_MAXi[] =        {-0.38,   -0.41,    -0.44,    -0.48,    -0.50 ,   -0.54,   -0.56};
    double errV_imon_MAXi[] =     {0.01,    0.01,     0.01,     0.01,     0.01  ,   0.01,    0.01};

    // LOAD: 224 (220 kOhm)
    double V_out_MINi[] =         {25.00,   27.50,    30.00,    32.50,    35.00 ,   37.49,   39.01};
    double errV_out_MINi[] =      {0.01,    0.01,     0.01,     0.01,     0.01  ,   0.01,    0.01};
    double V_vmon_MINi[] =        {-0.917,  -1.008,   -1.100,   -1.191,   -1.283,   -1.374,  -1.430};
    double errV_vmon_MINi[] =     {0.001,   0.001,    0.001,    0.001,    0.001 ,   0.001,   0.001};
    double V_imon_MINi[] =        {-0.14,   -0.15,    -0.16,    -0.17,    -0.18 ,   -0.18,   -0.19     };
    double errV_imon_MINi[] =     {0.01,    0.01,     0.01,     0.01,     0.01  ,   0.01,    0.01};
