...
void OperationPoint(){
    // HV
    double HV[] =                {32.00,33.00, 34.00, 35.00,36.00};
    double errHV[]=              {0.01,0.01, 0.01, 0.01,0.01};
    
    // Sigma_peak_0
    double Sigma_peak_0[] =      {2.19778e+00,2.18775e+00,2.35603,2.42307e+00,3.15461e+00};
    double errSigma_peak_0[] =   {5.09429e-02,5.55387e-02,7.16945e-02,5.57088e-02,1.07703e-01};
    
    // Sigma_peak_1
    double Sigma_peak_1[] =      {4.20742e+00,5.83062e+00,5.60473e+00,5.89185e+00,8.44510e+00};
    double errSigma_peak_1[] =   {1.79882e-01,1.53347e-01,1.22846e-01,1.13433e-01,3.08829e-01};
    
    // Mean_peak_1
    double Mean_peak_1[] =      {1.48305e+01,1.75317e+01,1.88485e+01,2.02275e+01,2.29223e+01};
    double errMean_peak_1[] =   {1.22590e-01,1.22079e-01,1.09392e-01,1.02673e-01,3.58637e-01};
      
    // Mean_peak_2
    double Mean_peak_2[] =      {2.66350e+01,3.11680e+01,3.60932e+01,4.02396e+01,4.48226e+01};
    double errMean_peak_2[] =   {4.38895e-01,2.54707e-01,1.64642e-01,1.65936e-01,6.91813e-01};
