 ...
 *   fit_hist_peaks_gaus_sum_01(...):
 *      [0]*TMath::Exp(-(x-[2])*(x-[2])/( 2*([4]*[4]))) +
 *      + [1]*TMath::Exp(-(x-[2]-[3])*(x-[2]-[3])/( 2*([4]*[4] + [5]*[5])))
 *
 * > Ana_Traces_SiPM.cxx github: 31/08/2018 # 1
 *
...
void DCR_CrossTalk_FBK_HD3_2_DARK_LASER_Gaus01_data_2018_07(){
...
//*****************************************************************************
    ...
    // Other: dleddt = 9; smooth_trace_bool = 0;
    //        histLED_low = -50; histLED_high = 700; histLED_binw = 0.7;
    //        fit_low = -20; fit_high = 12;
    H_peak_0[n_SiPM][0]          = 723.102;
    errH_peak_0[n_SiPM][0]       = 13.2893;
    Sigma_peak_0[n_SiPM][0]      = 1.91862;
    errSigma_peak_0[n_SiPM][0]   = 0.0341441;
    H_peak_1[n_SiPM][0]          = 1205.29;
    errH_peak_1[n_SiPM][0]       = 17.5034;
    Sigma_peak_1[n_SiPM][0]      = 2.60467;
    errSigma_peak_1[n_SiPM][0]   = 0.124136;
    Mean_peak_1[n_SiPM][0]       = 11.0066;
    errMean_peak_1[n_SiPM][0]    = 0.15004;
    GAIN[n_SiPM][0]              = 8.39894;
    errGAIN[n_SiPM][0]           = 0.141236;
    Sigma_add[n_SiPM][0]         = -1.7616;
    errSigma_add[n_SiPM][0]      = 0.17974;
    ...
    // Other: dleddt = 9; smooth_trace_bool = 0;
    //        histLED_low = -50; histLED_high = 700; histLED_binw = 0.7;
    //        fit_low = -20; fit_high = 15;
    H_peak_0[n_SiPM][1]          = 540.754;
    errH_peak_0[n_SiPM][1]       = 10.9739;
    Sigma_peak_0[n_SiPM][1]      = 2.06999;
    errSigma_peak_0[n_SiPM][1]   = 0.0359017;
    H_peak_1[n_SiPM][1]          = 895.475;
    errH_peak_1[n_SiPM][1]       = 13.3389;
    Sigma_peak_1[n_SiPM][1]      = 3.15939;
    errSigma_peak_1[n_SiPM][1]   = 0.11224;
    Mean_peak_1[n_SiPM][1]       = 13.2694;
    errMean_peak_1[n_SiPM][1]    = 0.1417;
    GAIN[n_SiPM][1]              = 10.9777;
    errGAIN[n_SiPM][1]           = 0.1341;
    Sigma_add[n_SiPM][1]         = 2.38681;
    errSigma_add[n_SiPM][1]      = 0.145272;
    ...
    // Other: dleddt = 9; smooth_trace_bool = 0;
    //        histLED_low = -50; histLED_high = 700; histLED_binw = 0.7;
    //        fit_low = -20; fit_high = 20;
    H_peak_0[n_SiPM][2]          = 437.074;
    errH_peak_0[n_SiPM][2]       = 9.72908;
    Sigma_peak_0[n_SiPM][2]      = 2.20516;
    errSigma_peak_0[n_SiPM][2]   = 0.0355742;
    H_peak_1[n_SiPM][2]          = 695.934;
    errH_peak_1[n_SiPM][2]       = 10.7991;
    Sigma_peak_1[n_SiPM][2]      = 3.46857;
    errSigma_peak_1[n_SiPM][2]   = 0.069941;
    Mean_peak_1[n_SiPM][2]       = 15.031;
    errMean_peak_1[n_SiPM][2]    = 0.0811572;
    GAIN[n_SiPM][2]              = 13.2478;
    errGAIN[n_SiPM][2]           = 0.0683578;
    Sigma_add[n_SiPM][2]         = 2.67736;
    errSigma_add[n_SiPM][2]      = 0.0857418;
    ...
    // Other: dleddt = 9; smooth_trace_bool = 0;
    //        histLED_low = -50; histLED_high = 700; histLED_binw = 0.7;
    //        fit_low = -20; fit_high = 23;
    H_peak_0[n_SiPM][3]          = 328.455;
    errH_peak_0[n_SiPM][3]       = 8.44807;
    Sigma_peak_0[n_SiPM][3]      = 2.56516;
    errSigma_peak_0[n_SiPM][3]   = 0.0506225;
    H_peak_1[n_SiPM][3]          = 533.777;
    errH_peak_1[n_SiPM][3]       = 9.25554;
    Sigma_peak_1[n_SiPM][3]      = 3.77598;
    errSigma_peak_1[n_SiPM][3]   = 0.086362;
    Mean_peak_1[n_SiPM][3]       = 16.9162;
    errMean_peak_1[n_SiPM][3]    = 0.0922206;
    GAIN[n_SiPM][3]              = 15.6661;
    errGAIN[n_SiPM][3]           = 0.0760828;
    Sigma_add[n_SiPM][3]         = 2.77092;
    errSigma_add[n_SiPM][3]      = 0.107954;
    ...
    H_peak_0[n_SiPM][5]          = 205.431;
    errH_peak_0[n_SiPM][5]       = 6.26037;
    Sigma_peak_0[n_SiPM][5]      = 3.13606;
    errSigma_peak_0[n_SiPM][5]   = 0.073164;
    H_peak_1[n_SiPM][5]          = 348.845;
    errH_peak_1[n_SiPM][5]       = 7.2033;
    Sigma_peak_1[n_SiPM][5]      = 4.61149;
    errSigma_peak_1[n_SiPM][5]   = 0.130038;
    Mean_peak_1[n_SiPM][5]       = 20.1809;
    errMean_peak_1[n_SiPM][5]    = 0.129;
    GAIN[n_SiPM][5]              = 20.4429;
    errGAIN[n_SiPM][5]           = 0.106662;
    Sigma_add[n_SiPM][5]         = 3.38098;
    errSigma_add[n_SiPM][5]      = 0.163869;
