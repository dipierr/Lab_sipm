/******************************************************************************\
 * DCR_CrossTalk_FBK_HD3_2_SensL_MicroFJ_SMTPA_60035_data_2018_07.C:
 *
 * DCR_CrossTalk_FBK_HD3_2_from_cnt_data_2018_07.C (at 20/08/2018)
 *          +
 * DCR_CrossTalk_SensL_MicroFJ_SMTPA_60035_data_2018_07.C
 *
 *
 * See the cited files for more information
 *
\******************************************************************************/
...
#define n_DCR_1_SensL 4
#define n_DCR_2_SensL 4
...
char title_DCR_SensL[80];
char title_DCR_SensL_mg[80];


#define h 600
#define w 1000

void DCR_CrossTalk_FBK_HD3_2_SensL_MicroFJ_SMTPA_60035_data_2018_07();
...
void DCR_CrossTalk_FBK_HD3_2_SensL_MicroFJ_SMTPA_60035_data_2018_07(){
    ...
    // gV_DCR_Del_1->GetXaxis()->SetTitle("Overvoltage (V)");
    ...
    // gV_DCR_Del_2->GetXaxis()->SetTitle("Overvoltage (V)");
    ...
    // gV_DCR_Del_3->GetXaxis()->SetTitle("Overvoltage (V)");
    ...
    // gV_CT_Del_3->GetXaxis()->SetTitle("Overvoltage (V)");
...
///////////////////////////////////////////////////////////////////////////////
    ...
    // SiPM1:
    double HV_1_SensL[n_DCR_1_SensL], errHV_1_SensL[n_DCR_1_SensL];
    double DCR_1_SensL[n_DCR_1_SensL], errDCR_1_SensL[n_DCR_1_SensL];
    double CT_1_SensL[n_DCR_1_SensL], errCT_1_SensL[n_DCR_1_SensL];
    double DCR_Del_1_SensL[n_DCR_1_SensL], errDCR_Del_1_SensL[n_DCR_1_SensL];
    double CT_Del_1_SensL[n_DCR_1_SensL], errCT_Del_1_SensL[n_DCR_1_SensL];
    // SiPM2:
    double HV_2_SensL[n_DCR_2_SensL], errHV_2_SensL[n_DCR_2_SensL];
    double DCR_2_SensL[n_DCR_2_SensL], errDCR_2_SensL[n_DCR_2_SensL];
    double CT_2_SensL[n_DCR_2_SensL], errCT_2_SensL[n_DCR_2_SensL];
    double DCR_Del_2_SensL[n_DCR_2_SensL], errDCR_Del_2_SensL[n_DCR_2_SensL];
    double CT_Del_2_SensL[n_DCR_2_SensL], errCT_Del_2_SensL[n_DCR_2_SensL];


    // EVALUARE DCR / Area_SensL
    bool dcr_Area_SensL = true;

    // Area_SensL:
    double Area_SensL;
    Area_SensL = 6.07*6.07;

    // Initialization
    for(int i=0; i<n_DCR_1_SensL; i++){
        HV_1_SensL[i] = errHV_1_SensL[i] = DCR_1_SensL[i] = errDCR_1_SensL[i] = CT_1_SensL[i] = errCT_1_SensL[i] = DCR_Del_1_SensL[i] = errDCR_Del_1_SensL[i] = CT_Del_1_SensL[i] = errCT_Del_1_SensL[i] = 0.;
    }
    for(int i=0; i<n_DCR_2_SensL; i++){
        HV_2_SensL[i] = errHV_2_SensL[i] = DCR_2_SensL[i] = errDCR_2_SensL[i] = CT_2_SensL[i] = errCT_2_SensL[i] = DCR_Del_2_SensL[i] = errDCR_Del_2_SensL[i] = CT_Del_2_SensL[i] = errCT_Del_2_SensL[i] = 0.;
    }

    // HV
    HV_1_SensL[0]    = 28.00;
    errHV_1_SensL[0] =  0.01;
    for(int i=1; i<n_DCR_1_SensL; i++){
        HV_1_SensL[i]    = HV_1_SensL[i-1]+1.;
        errHV_1_SensL[i] = errHV_1_SensL[0];
    }

    HV_2_SensL[0]    = 28.00;
    errHV_2_SensL[0] =  0.01;
    for(int i=1; i<n_DCR_2_SensL; i++){
        HV_2_SensL[i]    = HV_2_SensL[i-1]+1.;
        errHV_2_SensL[i] = errHV_2_SensL[0];
    }
    ...
    // pe_1_SensL_5_vect[4] = {17, 20, 22, 25}
    HV = 28.00;
    index = find_index(HV_1_SensL,  sizeof(HV_1_SensL)/sizeof(HV_1_SensL[0]), HV);
    DCR_1_SensL[find_index(HV_1_SensL,  sizeof(HV_1_SensL)/sizeof(HV_1_SensL[0]), HV)] = 3.82583;
    errDCR_1_SensL[find_index(HV_1_SensL,  sizeof(HV_1_SensL)/sizeof(HV_1_SensL[0]), HV)] = 0.00637308;
    CT_1_SensL[find_index(HV_1_SensL,  sizeof(HV_1_SensL)/sizeof(HV_1_SensL[0]), HV)] = 0.158867;
    DCR_Del_1_SensL[find_index(HV_1_SensL,  sizeof(HV_1_SensL)/sizeof(HV_1_SensL[0]), HV)] = 5.07058;
    errDCR_Del_1_SensL[find_index(HV_1_SensL,  sizeof(HV_1_SensL)/sizeof(HV_1_SensL[0]), HV)] = 0.0234848;
    CT_Del_1_SensL[find_index(HV_1_SensL,  sizeof(HV_1_SensL)/sizeof(HV_1_SensL[0]), HV)] = 0.367245;

    HV = 29.00;
    index = find_index(HV_1_SensL,  sizeof(HV_1_SensL)/sizeof(HV_1_SensL[0]), HV);
    DCR_1_SensL[find_index(HV_1_SensL,  sizeof(HV_1_SensL)/sizeof(HV_1_SensL[0]), HV)] = 6.15163;
    errDCR_1_SensL[find_index(HV_1_SensL,  sizeof(HV_1_SensL)/sizeof(HV_1_SensL[0]), HV)] = 0.00822183;
    CT_1_SensL[find_index(HV_1_SensL,  sizeof(HV_1_SensL)/sizeof(HV_1_SensL[0]), HV)] = 0.214115;
    DCR_Del_1_SensL[find_index(HV_1_SensL,  sizeof(HV_1_SensL)/sizeof(HV_1_SensL[0]), HV)] = 7.3883;
    errDCR_Del_1_SensL[find_index(HV_1_SensL,  sizeof(HV_1_SensL)/sizeof(HV_1_SensL[0]), HV)] = 0.0212815;
    CT_Del_1_SensL[find_index(HV_1_SensL,  sizeof(HV_1_SensL)/sizeof(HV_1_SensL[0]), HV)] = 0.360222;

    HV = 30.00;
    index = find_index(HV_1_SensL,  sizeof(HV_1_SensL)/sizeof(HV_1_SensL[0]), HV);
    DCR_1_SensL[find_index(HV_1_SensL,  sizeof(HV_1_SensL)/sizeof(HV_1_SensL[0]), HV)] = 8.19421;
    errDCR_1_SensL[find_index(HV_1_SensL,  sizeof(HV_1_SensL)/sizeof(HV_1_SensL[0]), HV)] = 0.00962935;
    CT_1_SensL[find_index(HV_1_SensL,  sizeof(HV_1_SensL)/sizeof(HV_1_SensL[0]), HV)] = 0.289273;
    DCR_Del_1_SensL[find_index(HV_1_SensL,  sizeof(HV_1_SensL)/sizeof(HV_1_SensL[0]), HV)] = 9.16169;
    errDCR_Del_1_SensL[find_index(HV_1_SensL,  sizeof(HV_1_SensL)/sizeof(HV_1_SensL[0]), HV)] = 0.0216425;
    CT_Del_1_SensL[find_index(HV_1_SensL,  sizeof(HV_1_SensL)/sizeof(HV_1_SensL[0]), HV)] = 0.400945;

    HV = 31.00;
    index = find_index(HV_1_SensL,  sizeof(HV_1_SensL)/sizeof(HV_1_SensL[0]), HV);
    DCR_1_SensL[find_index(HV_1_SensL,  sizeof(HV_1_SensL)/sizeof(HV_1_SensL[0]), HV)] = 10.777;
    errDCR_1_SensL[find_index(HV_1_SensL,  sizeof(HV_1_SensL)/sizeof(HV_1_SensL[0]), HV)] = 0.0112431;
    CT_1_SensL[find_index(HV_1_SensL,  sizeof(HV_1_SensL)/sizeof(HV_1_SensL[0]), HV)] = 0.361095;
    DCR_Del_1_SensL[find_index(HV_1_SensL,  sizeof(HV_1_SensL)/sizeof(HV_1_SensL[0]), HV)] = 10.8933;
    errDCR_Del_1_SensL[find_index(HV_1_SensL,  sizeof(HV_1_SensL)/sizeof(HV_1_SensL[0]), HV)] = 0.0230686;
    CT_Del_1_SensL[find_index(HV_1_SensL,  sizeof(HV_1_SensL)/sizeof(HV_1_SensL[0]), HV)] = 0.443454;
    ...
    // pe_1_SensL_5_vect[4] = {22, 26, 30, 35}
    HV = 28.00;
    index = find_index(HV_2_SensL,  sizeof(HV_2_SensL)/sizeof(HV_2_SensL[0]), HV);
    DCR_2_SensL[find_index(HV_2_SensL,  sizeof(HV_2_SensL)/sizeof(HV_2_SensL[0]), HV)] = 5.09667;
    errDCR_2_SensL[find_index(HV_2_SensL,  sizeof(HV_2_SensL)/sizeof(HV_2_SensL[0]), HV)] = 0.00742597;
    CT_2_SensL[find_index(HV_2_SensL,  sizeof(HV_2_SensL)/sizeof(HV_2_SensL[0]), HV)] = 0.136213;
    DCR_Del_2_SensL[find_index(HV_2_SensL,  sizeof(HV_2_SensL)/sizeof(HV_2_SensL[0]), HV)] = 6.4611;
    errDCR_Del_2_SensL[find_index(HV_2_SensL,  sizeof(HV_2_SensL)/sizeof(HV_2_SensL[0]), HV)] = 0.0218516;
    CT_Del_2_SensL[find_index(HV_2_SensL,  sizeof(HV_2_SensL)/sizeof(HV_2_SensL[0]), HV)] = 0.342274;


    HV = 29.00;
    index = find_index(HV_2_SensL,  sizeof(HV_2_SensL)/sizeof(HV_2_SensL[0]), HV);
    DCR_2_SensL[find_index(HV_2_SensL,  sizeof(HV_2_SensL)/sizeof(HV_2_SensL[0]), HV)] = 7.03377;
    errDCR_2_SensL[find_index(HV_2_SensL,  sizeof(HV_2_SensL)/sizeof(HV_2_SensL[0]), HV)] = 0.00884792;
    CT_2_SensL[find_index(HV_2_SensL,  sizeof(HV_2_SensL)/sizeof(HV_2_SensL[0]), HV)] = 0.200065;
    DCR_Del_2_SensL[find_index(HV_2_SensL,  sizeof(HV_2_SensL)/sizeof(HV_2_SensL[0]), HV)] = 8.183;
    errDCR_Del_2_SensL[find_index(HV_2_SensL,  sizeof(HV_2_SensL)/sizeof(HV_2_SensL[0]), HV)] = 0.0213146;
    CT_Del_2_SensL[find_index(HV_2_SensL,  sizeof(HV_2_SensL)/sizeof(HV_2_SensL[0]), HV)] = 0.334543;

    HV = 30.00;
    index = find_index(HV_2_SensL,  sizeof(HV_2_SensL)/sizeof(HV_2_SensL[0]), HV);
    DCR_2_SensL[find_index(HV_2_SensL,  sizeof(HV_2_SensL)/sizeof(HV_2_SensL[0]), HV)] = 8.81432;
    errDCR_2_SensL[find_index(HV_2_SensL,  sizeof(HV_2_SensL)/sizeof(HV_2_SensL[0]), HV)] = 0.0100308;
    CT_2_SensL[find_index(HV_2_SensL,  sizeof(HV_2_SensL)/sizeof(HV_2_SensL[0]), HV)] = 0.272034;
    DCR_Del_2_SensL[find_index(HV_2_SensL,  sizeof(HV_2_SensL)/sizeof(HV_2_SensL[0]), HV)] = 9.7331;
    errDCR_Del_2_SensL[find_index(HV_2_SensL,  sizeof(HV_2_SensL)/sizeof(HV_2_SensL[0]), HV)] = 0.0223014;
    CT_Del_2_SensL[find_index(HV_2_SensL,  sizeof(HV_2_SensL)/sizeof(HV_2_SensL[0]), HV)] = 0.381575;

    HV = 31.00;
    index = find_index(HV_2_SensL,  sizeof(HV_2_SensL)/sizeof(HV_2_SensL[0]), HV);
    DCR_2_SensL[find_index(HV_2_SensL,  sizeof(HV_2_SensL)/sizeof(HV_2_SensL[0]), HV)] = 11.1032;
    errDCR_2_SensL[find_index(HV_2_SensL,  sizeof(HV_2_SensL)/sizeof(HV_2_SensL[0]), HV)] = 0.0114374;
    CT_2_SensL[find_index(HV_2_SensL,  sizeof(HV_2_SensL)/sizeof(HV_2_SensL[0]), HV)] = 0.352952;
    DCR_Del_2_SensL[find_index(HV_2_SensL,  sizeof(HV_2_SensL)/sizeof(HV_2_SensL[0]), HV)] = 11.5422;
    errDCR_Del_2_SensL[find_index(HV_2_SensL,  sizeof(HV_2_SensL)/sizeof(HV_2_SensL[0]), HV)] = 0.0238066;
    CT_Del_2_SensL[find_index(HV_2_SensL,  sizeof(HV_2_SensL)/sizeof(HV_2_SensL[0]), HV)] = 0.434841;
    ...
    if(percentage_error_bool){
        double err_rel = 0.05;
        for(int i=0; i<n_DCR_1_SensL; i++){
            errDCR_1_SensL[i] = err_rel * DCR_1_SensL[i];
        }
        for(int i=0; i<n_DCR_2_SensL; i++){
            errDCR_2_SensL[i] = err_rel * DCR_2_SensL[i];
        }

        for(int i=0; i<n_DCR_1_SensL; i++){
            errCT_1_SensL[i] = err_rel * CT_1_SensL[i];
        }
        for(int i=0; i<n_DCR_2_SensL; i++){
            errCT_2_SensL[i] = err_rel * CT_2_SensL[i];
        }

        for(int i=0; i<n_DCR_1_SensL; i++){
            errDCR_Del_1_SensL[i] = err_rel * DCR_Del_1_SensL[i];
        }
        for(int i=0; i<n_DCR_1_SensL; i++){
            errDCR_Del_2_SensL[i] = err_rel * DCR_Del_2_SensL[i];
        }

        for(int i=0; i<n_DCR_1_SensL; i++){
            errCT_Del_1_SensL[i] = err_rel * CT_Del_1_SensL[i];
        }
        for(int i=0; i<n_DCR_1_SensL; i++){
            errCT_Del_2_SensL[i] = err_rel * CT_Del_2_SensL[i];
        }
    ...
    if(fix_error_bool){
        ...
        double err_fix_CT = 0.02;
        for(int i=0; i<n_DCR_1_SensL; i++){
            errDCR_1_SensL[i] = err_fix_DCR;
        }
        for(int i=0; i<n_DCR_2_SensL; i++){
            errDCR_2_SensL[i] = err_fix_DCR;
        }

        for(int i=0; i<n_DCR_1_SensL; i++){
            errCT_1_SensL[i] = err_fix_CT;
        }
        for(int i=0; i<n_DCR_2_SensL; i++){
            errCT_2_SensL[i] = err_fix_CT;
        }

        for(int i=0; i<n_DCR_1_SensL; i++){
            errDCR_Del_1_SensL[i] = err_fix_DCR;
        }
        for(int i=0; i<n_DCR_1_SensL; i++){
            errDCR_Del_2_SensL[i] = err_fix_DCR;
        }

        for(int i=0; i<n_DCR_1_SensL; i++){
            errCT_Del_1_SensL[i] = err_fix_CT;
        }
        for(int i=0; i<n_DCR_1_SensL; i++){
            errCT_Del_2_SensL[i] = err_fix_CT;
        }
    ...
    if(dcr_Area_SensL){
        for(int i=0; i< n_DCR_1_SensL; i++){
            DCR_1_SensL[i]  /= Area_SensL;
            errDCR_1_SensL[i] /= Area_SensL;
            DCR_1_SensL[i]  *= 1e3;
            errDCR_1_SensL[i] *= 1e3;
        }
        for(int i=0; i< n_DCR_2_SensL; i++){
            DCR_2_SensL[i]  /= Area_SensL;
            errDCR_2_SensL[i] /= Area_SensL;
            DCR_2_SensL[i]  *= 1e3;
            errDCR_2_SensL[i] *= 1e3;
        }
        ...
        for(int i=0; i< n_DCR_1_SensL; i++){
            DCR_Del_1_SensL[i]  /= Area_SensL;
            errDCR_Del_1_SensL[i] /= Area_SensL;
            DCR_Del_1_SensL[i]  *= 1e3;
            errDCR_Del_1_SensL[i] *= 1e3;
        }
        for(int i=0; i< n_DCR_2_SensL; i++){
            DCR_Del_2_SensL[i]  /= Area_SensL;
            errDCR_Del_2_SensL[i] /= Area_SensL;
            DCR_Del_2_SensL[i]  *= 1e3;
            errDCR_Del_2_SensL[i] *= 1e3;
        }
    ...
    for(int i=0; i<n_DCR_1_SensL; i++){
        HV_1_SensL[i] -= V_bd_SensL;
        HV_2_SensL[i] -= V_bd_SensL;
    }
    ...
    TGraphErrors *gV_DCR_1_SensL  = new TGraphErrors(n_DCR_1_SensL, HV_1_SensL, DCR_1_SensL, errHV_1_SensL, errDCR_1_SensL);
    TGraphErrors *gV_DCR_2_SensL  = new TGraphErrors(n_DCR_2_SensL, HV_2_SensL, DCR_2_SensL, errHV_2_SensL, errDCR_2_SensL);

    TGraphErrors *gV_CT_1_SensL  = new TGraphErrors(n_DCR_1_SensL, HV_1_SensL, CT_1_SensL, errHV_1_SensL, errCT_1_SensL);
    TGraphErrors *gV_CT_2_SensL  = new TGraphErrors(n_DCR_2_SensL, HV_2_SensL, CT_2_SensL, errHV_2_SensL, errCT_2_SensL);

    //------------------------------

    if(dcr_Area_SensL) strcpy(title_DCR_SensL, "\\frac{DCR}{Area} \\left(\\frac{kHz}{mm^2}\\right)");
    else         strcpy(title_DCR_SensL, "DCR (MHz)");

    strcpy(title_DCR_SensL_mg, ";Overvoltage (V); ");
    strcat(title_DCR_SensL_mg, title_DCR_SensL);

    gV_DCR_1_SensL->SetMarkerStyle(20);
    gV_DCR_1_SensL->SetMarkerColor(kGreen+1);
    gV_DCR_1_SensL->SetTitle();
    gV_DCR_1_SensL->GetXaxis()->SetTitle("Overvoltage (V)");
    gV_DCR_1_SensL->GetYaxis()->SetTitle(title_DCR_SensL);

    gV_DCR_2_SensL->SetMarkerStyle(20);
    gV_DCR_2_SensL->SetMarkerColor(kBlue);
    gV_DCR_2_SensL->SetTitle();
    gV_DCR_2_SensL->GetXaxis()->SetTitle("Overvoltage (V)");
    gV_DCR_2_SensL->GetYaxis()->SetTitle(title_DCR_SensL);


    //------------------------------

    gV_CT_1_SensL->SetMarkerStyle(20);
    gV_CT_1_SensL->SetMarkerColor(kGreen+1);
    gV_CT_1_SensL->SetTitle();
    gV_CT_1_SensL->GetXaxis()->SetTitle("Overvoltage (V)");
    gV_CT_1_SensL->GetYaxis()->SetTitle("Cross Talk");

    gV_CT_2_SensL->SetMarkerStyle(20);
    gV_CT_2_SensL->SetMarkerColor(kBlue);
    gV_CT_2_SensL->SetTitle();
    gV_CT_2_SensL->GetXaxis()->SetTitle("Overvoltage (V)");
    gV_CT_2_SensL->GetYaxis()->SetTitle("Cross Talk");


    //------------------------------

    auto legendDCR_SensL = new TLegend(0.15,0.70,0.35,0.85);
    legendDCR_SensL->AddEntry(gV_DCR_1_SensL,"SensL MicroFJ (1)","p");
    legendDCR_SensL->AddEntry(gV_DCR_2_SensL,"SensL MicroFJ (2)","p");

    auto legendCT_SensL = new TLegend(0.15,0.70,0.35,0.85);
    legendCT_SensL->AddEntry(gV_CT_1_SensL,"SensL MicroFJ (1)","p");
    legendCT_SensL->AddEntry(gV_CT_2_SensL,"SensL MicroFJ (2)","p");
    ...
    TCanvas *cDCR_SensL = new TCanvas("cDCR_SensL", "cDCR_SensL",w,h);
    cDCR_SensL->SetGrid();
    TMultiGraph *mgDCR_SensL = new TMultiGraph("mgDCR_SensL", title_DCR_SensL_mg);
    mgDCR_SensL->Add(gV_DCR_1_SensL);
    mgDCR_SensL->Add(gV_DCR_2_SensL);
    mgDCR_SensL->Draw("AP");
    legendDCR_SensL->Draw();
    ...
    legendDCR_FBK_SensL->AddEntry(gV_DCR_1,      "FBK NUV HD3-2 (1)","p");
    legendDCR_FBK_SensL->AddEntry(gV_DCR_2,      "FBK NUV HD3-2 (2)","p");
    legendDCR_FBK_SensL->AddEntry(gV_DCR_3,      "FBK NUV HD3-2 (3)","p");
    legendDCR_FBK_SensL->AddEntry(gV_DCR_1_SensL,"SensL MicroFJ (1)","p");
    legendDCR_FBK_SensL->AddEntry(gV_DCR_2_SensL,"SensL MicroFJ (2)","p");

    auto legendCT_FBK_SensL = new TLegend(0.15,0.70,0.4,0.9);
    legendCT_FBK_SensL->AddEntry(gV_CT_1,      "FBK NUV HD3-2 (1)","p");
    legendCT_FBK_SensL->AddEntry(gV_CT_2,      "FBK NUV HD3-2 (2)","p");
    legendCT_FBK_SensL->AddEntry(gV_CT_3,      "FBK NUV HD3-2 (3)","p");
    legendCT_FBK_SensL->AddEntry(gV_CT_1_SensL,"SensL MicroFJ (1)","p");
    legendCT_FBK_SensL->AddEntry(gV_CT_2_SensL,"SensL MicroFJ (2)","p");

    //------------------------------


    TCanvas *cDCR_FBK_SensL = new TCanvas("cDCR_FBK_SensL", "cDCR_FBK_SensL",w,h);
    cDCR_FBK_SensL->SetGrid();
    TMultiGraph *mgDCR_FBK_SensL = new TMultiGraph("mgDCR_FBK_SensL", title_DCR_SensL_mg);
    mgDCR_FBK_SensL->Add(gV_DCR_1);
    mgDCR_FBK_SensL->Add(gV_DCR_2);
    mgDCR_FBK_SensL->Add(gV_DCR_3);
    mgDCR_FBK_SensL->Add(gV_DCR_1_SensL);
    mgDCR_FBK_SensL->Add(gV_DCR_2_SensL);
    mgDCR_FBK_SensL->Draw("AP");
    ...
    mgCT_FBK_SensL->Add(gV_CT_1_SensL);
    mgCT_FBK_SensL->Add(gV_CT_2_SensL);
    mgCT_FBK_SensL->Draw("AP");
