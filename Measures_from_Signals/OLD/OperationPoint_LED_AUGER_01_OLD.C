...
void OperationPoint(){
    ...
    // Mean hist global
    double Mean_hg[]=  {13.37,21.1, 31.28,        38.89,        51.58,        65.41,        73.94,        80.43,        89.72,        98.15};
    double errMean_hg[]={0.03227,0.05395,0.08042, 0.1069,       0.1441,       0.1832,       0.2069,       0.229,        0.254,        0.2756};

    // Standard_dev_hist_global
    double Std_hg[] =  {7.217,12.06,17.98,        23.9,         32.22,        40.97,        46.26,        51.21,        56.8,        69.37};
    double errStd_hg[]={0.02282,0.03815,0.05687,  0.07559,      0.1019,       0.1295,       0.1463,       0.1619,       0.1796,      0.1949};
